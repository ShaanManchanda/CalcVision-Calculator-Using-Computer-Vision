...
def gen_frames():
    ...
    while True:
        ...
        if not success:
            ...
            # Ensure imgCanvas and imgInv match the resolution of img
            ...
            # Resize the asset image to match the width of the webcam frame
            asset_resized = cv.resize(asset, (img.shape[1], 125))  # Resize to match the width of img
            img[0:125, 0:img.shape[1]] = asset_resized
